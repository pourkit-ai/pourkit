...
Use Code Context Engine first for exploratory codebase work:
- answering questions about code behavior or architecture (`context_search`)
- finding related code, functions, or patterns (`context_search`)
- expanding relevant chunks only after search results identify them (`expand_chunk`)
- checking related callers/imports when needed (`related_context`)
